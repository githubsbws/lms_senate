        ...
        <div class="content">
            <main>
                <div class="section">
                    ...
                    <div class="section-body">
                        <form  action="{{ route('admin.document_uploadLargeDocument',['id' => $id]) }}" method="POST" enctype="multipart/form-data" class="max-w-sm mx-auto">
                            @csrf
                        <div class="section d-flex mb-3">
                            <div class="col">
                            <label>เอกสารที่เกิน 15 หน้า</label>
                            <input class="form-control" id="file_input" type="file" name="scan">
                            </div>
                            <div class="col">
                            <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#documentModal">

...
class AdminController extends Controller
{
    ...
    {
        if(Auth::check() && !is_null(Auth::user()->type_user_id )){
    ...
    public function getCountDocRequest()
    {
        $docRequest = Approve::where('status','waiting')->where('active','y')->count();
        return response()->json(['countDocRequest' => $docRequest]);
    }
}